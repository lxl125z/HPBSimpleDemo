Pod::Spec.new do |s|
s.name             = "HPBSimpleDemo"   #名称
s.version          = "1.0.0"           #版本号
s.summary          = "HPBSimpleDemo is a universal docking protocol for digital asset wallets and dapp used on iOS." #简短介绍
s.description      = <<-DESC
HPBSimpleDemo is a universal docking protocol for digital asset wallets and dapp used on iOS, which implement by Swift.   #描述
DESC
